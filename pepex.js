...
async function lordKirStart() {
    ...
    const sock = sockConnect({
        ...
        browser: ['ZanzBotz Multi-Device','Safari','1.0.0'],
        auth: state,
        version
    })
...
console.log(color('Instagram :', 'cyan'), color(`@Denzz`, 'yellow'))
console.log(color('Github :', 'cyan'), color(`Denzz`, 'yellow'))
console.log(color('Wangsap :', 'cyan'), color(`0895424020886`, 'yellow'))
...
sock.browserDescription = ["Denzz Multi-Device", "Safari", "1.0.0"];
